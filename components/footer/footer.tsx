          ...
          <div className="w-full max-w-[800px] flex flex-col items-center">
            ...
            >
              {footerContent.quickLinks.map((item, index) => (
                <motion.a
                  key={item.id}
                  href={item.href}
                  className="text-paragraph text-center font-inter text-base sm:text-lg lg:text-xl font-bold leading-6 hover:text-orange-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 rounded-sm whitespace-nowrap"
                  variants={{
            ...
            >
              ...
              >
                ...
                <span className="text-paragraph font-inter text-base sm:text-lg font-normal leading-6 whitespace-nowrap">
            ...
            {/* Company Description */}
            <motion.p 
              className="text-paragraph text-center font-inter text-base sm:text-lg font-normal leading-7 max-w-[600px] sm:max-w-[700px] px-4"
